...
/**
 * Returns the true hostname of the current page in the browser.
 * If the page is running in a iframe with srcdoc, the ancestor hostname is returned.
 * @returns {String} The true hostname
 */
export function getHostname() {
  const { location } = window;
  return location.href === 'about:srcdoc' ? window.parent.location.hostname : location.hostname;
}
